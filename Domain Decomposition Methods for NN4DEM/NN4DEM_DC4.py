...
input_shape_domain = (1, 1, domain_size_z, half_domain_size_y+2, half_domain_size_x+2)
...
z_decomposition_boundary_right_1   = torch.tensor([domain_size_z,domain_size_z,domain_size_z,domain_size_z])
...
z_decomposition_boundary_right_2   = torch.tensor([domain_size_z,domain_size_z,domain_size_z,domain_size_z])
...
cell_adjustment_z = torch.tensor([0,0,0,0,0])
