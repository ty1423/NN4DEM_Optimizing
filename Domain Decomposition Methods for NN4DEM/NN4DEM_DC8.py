...
input_shape_domain = (1, 1, half_domain_size_z+2, half_domain_size_y+2, half_domain_size_x+2)
...
x_decomposition_boundary_left_1    = torch.tensor([-1, -1, -1, -1, half_domain_size_x-1-2, half_domain_size_x-1-2, half_domain_size_x-1-2, half_domain_size_x-1-2])
x_decomposition_boundary_right_1  = torch.tensor([half_domain_size_x+2, half_domain_size_x+2, half_domain_size_x+2, half_domain_size_x+2, 2*domain_size_x, 2*domain_size_x, 2*domain_size_x, 2*domain_size_x])

y_decomposition_boundary_left_1    = torch.tensor([-1, half_domain_size_y-1-2, half_domain_size_y-1-2, -1, -1, half_domain_size_y-1-2, half_domain_size_y-1-2, -1])
y_decomposition_boundary_right_1  = torch.tensor([half_domain_size_y+2, 2*domain_size_y, 2*domain_size_y, half_domain_size_y+2, half_domain_size_y+2, 2*domain_size_y, 2*domain_size_y, half_domain_size_y+2])

z_decomposition_boundary_left_1    = torch.tensor([-1, -1, half_domain_size_z-1-2, half_domain_size_z-1-2, -1, -1, half_domain_size_z-1-2, half_domain_size_z-1-2])
z_decomposition_boundary_right_1  = torch.tensor([half_domain_size_z+2, half_domain_size_z+2, 2*domain_size_z, 2*domain_size_z, half_domain_size_z+2, half_domain_size_z+2, 2*domain_size_z, 2*domain_size_z])

x_decomposition_boundary_left_2    = torch.tensor([-1, -1, -1, -1, half_domain_size_x-1, half_domain_size_x-1, half_domain_size_x-1, half_domain_size_x-1])
x_decomposition_boundary_right_2  = torch.tensor([half_domain_size_x, half_domain_size_x, half_domain_size_x, half_domain_size_x, 2*domain_size_x, 2*domain_size_x, 2*domain_size_x, 2*domain_size_x])

y_decomposition_boundary_left_2    = torch.tensor([-1, half_domain_size_y-1, half_domain_size_y-1, -1, -1, half_domain_size_y-1, half_domain_size_y-1, -1])
y_decomposition_boundary_right_2  = torch.tensor([half_domain_size_y, 2*domain_size_y, 2*domain_size_y, half_domain_size_y, half_domain_size_y, 2*domain_size_y, 2*domain_size_y, half_domain_size_y])

z_decomposition_boundary_left_2    = torch.tensor([-1, -1, half_domain_size_z-1, half_domain_size_z-1, -1, -1, half_domain_size_z-1, half_domain_size_z-1])
z_decomposition_boundary_right_2  = torch.tensor([half_domain_size_z, half_domain_size_z, 2*domain_size_z, 2*domain_size_z, half_domain_size_z, half_domain_size_z, 2*domain_size_z, 2*domain_size_z])

conditions = {
    'x': torch.tensor([4, 5, 6, 7]),
    'y': torch.tensor([1, 2, 5, 6]),
    'z': torch.tensor([2, 3, 6, 7])
}
...
class AI4DEM(nn.Module):
    ...
    def forward(self, compressed_x_grid, compressed_y_grid, compressed_z_grid, compressed_vx_grid, compressed_vy_grid, compressed_vz_grid, d, kn, damping_coefficient_Eta, friction_coefficient, dt, input_shape, filter_size):
        ...
        for domain_number in range(8):
            ...
            # Convert to a tensor if it's a scalar
            domain_number_tensor = torch.tensor(domain_number).to(device)  
            condition_x = torch.isin(domain_number_tensor, conditions['x'].to(device))
            condition_y = torch.isin(domain_number_tensor, conditions['y'].to(device))
            condition_z = torch.isin(domain_number_tensor, conditions['z'].to(device))
            
            cell_xold_domain = torch.where(condition_x, cell_xold_domain - half_domain_size_x+1, cell_xold_domain)
            cell_yold_domain = torch.where(condition_y, cell_yold_domain - half_domain_size_y+1, cell_yold_domain)
            cell_zold_domain = torch.where(condition_z, cell_zold_domain - half_domain_size_z+1, cell_zold_domain)
